...
from config.constant import CUSTOM_VALUE,LOCATION_LEFT_BOTTOM,LOCATION_LEFT_TOP,LOCATION_RIGHT_BOTTOM,LOCATION_RIGHT_TOP
...
class Config(object):
    ...
    def set_output_dir(self,output_path):
        self._data['base']['output_dir'] = output_path
